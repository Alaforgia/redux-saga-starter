...
// Bring Redux Saga into our project
import createSagaMiddleware from "redux-saga";
import logger from "redux-logger";
import { takeEvery, put } from "redux-saga/effects";
import axios from "axios";
import elementList from "./Reducers/elementList.reducer";
import postElement from "./sagas/addElement.saga.js";
import fetchElements from "./sagas/fetchElements.saga.js";
...
function* firstSaga(action) {
  console.log("firstSage was hit with action:", action);
}
